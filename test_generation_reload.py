...
assert refresh_generation_modules("0.17.3") is True
# This is the guard used by app.py after the author stack has been refreshed.
if curriculum_runtime.RUNTIME_VERSION != "0.17.3":
...
assert refresh_generation_modules("0.17.3") is False
''')
...
assert scene_pipeline.SCENE_PIPELINE_VERSION == 2
assert clinical_scene.SCENE_RENDER_VERSION == 8

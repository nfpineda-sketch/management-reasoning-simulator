...
assert refresh_generation_modules("0.23.0") is True
# This is the guard used by app.py after the author stack has been refreshed.
if curriculum_runtime.RUNTIME_VERSION != "0.23.0":
...
assert refresh_generation_modules("0.23.0") is False
''')
...
assert scene_pipeline.SCENE_PIPELINE_VERSION == 7

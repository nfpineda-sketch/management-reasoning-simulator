...
assert refresh_generation_modules("0.17.4") is True
# This is the guard used by app.py after the author stack has been refreshed.
if curriculum_runtime.RUNTIME_VERSION != "0.17.4":
...
assert refresh_generation_modules("0.17.4") is False
''')
...
assert clinical_scene.SCENE_RENDER_VERSION == 9

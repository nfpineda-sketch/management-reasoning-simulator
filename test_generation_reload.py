...
assert refresh_generation_modules("0.24.6") is True
# This is the guard used by app.py after the author stack has been refreshed.
if curriculum_runtime.RUNTIME_VERSION != "0.24.6":
...
assert refresh_generation_modules("0.24.6") is False
''')
...
from generation_reload import refresh_generation_modules
assert generated_case.GENERATOR_VERSION == '0.24.6'
assert encounter_generator.GENERATOR_VERSION == '0.24.6'

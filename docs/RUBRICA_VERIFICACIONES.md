...
**Dos verificaciones de esa decisión, 2026-09-23.** Una llamada por cada caso con un alta insegura definida, replicando las mismas órdenes. En los dos el evento **se propone ahora** y D5 cae a 0: `Base 9/15 · Penalización −3 · Ajustado 6/15`. En `opioid_67f` el modelo usó la regla como argumento a favor del evento —*"The case offered exposure details on asking (long-acting agent), which were not obtained"*— y rechazó el "reevalúo en 15 minutos" del residente como plan de observación. **D2 es donde no llegó:** nombró la omisión en la evidencia en contra las dos veces y la puntuó distinto (3 y 2). Nombrarla es consistente; dejar que mueva el número, no. **Quince solicitudes pagadas en total, de veinte autorizadas.**

...
_SYNTAX_EXAMPLES = (
    ...
    "Give tenecteplase 40 mg IV",
    "Give octreotide 100 mcg SC",
...
def executable_generation_constraints():
    ...
    return {
        ...
        "contract_notes": [
            ...
            "trajectory_numeric_bounds constrain the authored model, not the terminal state. When the core reaches terminal collapse it reports no measurable pressure or perfusion: systolic and diastolic pressure read 0, capillary refill is unavailable and the rhythm becomes PEA. A preview frame showing that is the arrest itself, not a bounds violation to repair.",
            "The executor canonicalizes the sinus and atrial fibrillation label families: every sinus variant is reported as 'Sinus rhythm' and every atrial fibrillation variant as 'AF', whatever the authored label. The rate is displayed beside it. Other rhythms are reported as authored. A preview whose rhythm label differs from the authored one only in that way is canonicalization, not a contradiction.",
        ],
    }
